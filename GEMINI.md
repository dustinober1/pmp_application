...
*   **Professional Formatting:** Removed emojis from all study content (markdown) and data (JSON) files across the entire application to maintain a professional, state-of-the-art aesthetic. Improved table styling in SanitizedMarkdown component with theme-aware borders, backgrounds, and hover states for better visibility in both light and dark modes.

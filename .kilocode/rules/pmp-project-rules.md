...
- **Commit Narrative:** The git history must tell the story of how the application was built. Use descriptive commit messages that explain _why_ a change was made, not just _what_ changed.

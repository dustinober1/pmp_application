  ...
  [644],
  {
        ...
        var t = {
            229: function (e) {
              ...
              var c = [],
                ...
                d = -1;
              function u() {
                l && a && ((l = !1), a.length ? (c = a.concat(c)) : (d = -1), c.length && h());
              }
              function h() {
                if (!l) {
                  var e = i(u);
    ...
    7701: function (e, t, r) {
      ...
      var a = r(7573),
        ...
        n = r(7653);
      function i() {
        let { user: e, isAuthenticated: t, logout: r } = (0, o.a)(),
          [i, c] = (0, n.useState)(!1);
        return (0, a.jsx)('nav', {
    ...
    7070: function (e, t, r) {
      ...
      function c(e) {
        let { children: t } = e,
          [r, o] = (0, s.useState)({ user: null, token: null, isLoading: !0, isAuthenticated: !1 });
        (0, s.useEffect)(() => {
        ...
        let c = async e => {
          ...
          l = async (e, t) => {
            ...
            if (!r.ok) {
              var s;
              throw Error(
                (null === (s = a.error) || void 0 === s ? void 0 : s.message) || 'Login failed'
              );
            }
          ...
          d = async (e, t, r) => {
            ...
            if (!a.ok) {
              var n;
              throw Error(
                (null === (n = s.error) || void 0 === n ? void 0 : n.message) ||
                  'Registration failed'
              );
            }
            let { accessToken: c, refreshToken: l, user: d } = s.data;
    ...
    5118: function (e, t, r) {
      ...
      let a = r(4859).env.NEXT_PUBLIC_API_URL || 'http://localhost:3001/api';
      async function s() {
      ...
      let n = {
        ...
        i = {
          ...
          recordResponse: (e, t, r, a) =>
            o('/flashcards/sessions/'.concat(e, '/responses/').concat(t), {
              method: 'POST',
              body: { rating: r, timeSpentMs: a },
            }),
          completeSession: e =>
        ...
        c = {
          ...
          submitAnswer: (e, t, r, a) =>
            o('/practice/sessions/'.concat(e, '/answers/').concat(t), {
              method: 'POST',
              body: { selectedOptionId: r, timeSpentMs: a },
            }),

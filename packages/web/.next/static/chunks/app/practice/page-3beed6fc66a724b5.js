(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  ...
  {
    9267: function (e, s, a) {
      Promise.resolve().then(a.bind(a, 2842));
    },
    2842: function (e, s, a) {
      'use strict';
      (a.r(s),
      ...
      function o() {
        let e = (0, l.useRouter)(),
          { user: s, isAuthenticated: a, isLoading: o } = (0, i.a)(),
        ...
        let w = async () => {
            try {
              var e, s;
              let [a, t] = await Promise.all([d.tF.getStats(), d.sA.getDomains()]);
              (x(null === (e = a.data) || void 0 === e ? void 0 : e.stats),
                h((null === (s = t.data) || void 0 === s ? void 0 : s.domains) || []));
            } catch (e) {
          ...
          k = async () => {
            ...
            try {
              var s;
              let a = await d.tF.startSession({
                  domainIds: v.length > 0 ? v : void 0,
                  questionCount: g,
                }),
                t = null === (s = a.data) || void 0 === s ? void 0 : s.sessionId;
              t && e.push('/practice/session/'.concat(t));
            } catch (e) {
          ...
          S = async () => {
            ...
            try {
              var s;
              let a = await d.tF.startMockExam(),
                t = null === (s = a.data) || void 0 === s ? void 0 : s.sessionId;
              t && e.push('/practice/session/'.concat(t, '?mock=true'));
            } catch (e) {
          ...
          F = e => {
            f(s => (s.includes(e) ? s.filter(s => s !== e) : [...s, e]));
          };
        if (o || j)
          return (0, t.jsx)('div', {
        ...
        let C =
          (null == s ? void 0 : s.tier) === 'high-end' ||
          (null == s ? void 0 : s.tier) === 'corporate';
        return (0, t.jsxs)('div', {
                  ...
                  children: [
                    (0, t.jsxs)('div', {
                      ...
                      children: [
                        (0, t.jsx)('p', {
                          ...
                          children: (null == m ? void 0 : m.totalSessions) || 0,
                        }),
                        (0, t.jsx)('p', {
                    ...
                    (0, t.jsxs)('div', {
                      ...
                      children: [
                        (0, t.jsx)('p', {
                          className: 'text-3xl font-bold',
                          children: (null == m ? void 0 : m.totalQuestions) || 0,
                        }),
                        (0, t.jsx)('p', {
                          className: 'text-sm text-[var(--foreground-muted)]',
                    ...
                    (0, t.jsxs)('div', {
                      ...
                      children: [
                        (0, t.jsxs)('p', {
                          ...
                          children: [(null == m ? void 0 : m.averageScore) || 0, '%'],
                        }),
                        (0, t.jsx)('p', {
                          className: 'text-sm text-[var(--foreground-muted)]',
                    ...
                    (0, t.jsxs)('div', {
                      ...
                      children: [
                        (0, t.jsxs)('p', {
                          ...
                          children: [(null == m ? void 0 : m.bestScore) || 0, '%'],
                        }),
                        (0, t.jsx)('p', {
                          className: 'text-sm text-[var(--foreground-muted)]',
                          children: 'Best Score',
                        ...
                        (0, t.jsxs)('div', {
                          ...
                          children: [
                                  ...
                                  children: u.map(e =>
                                    (0, t.jsx)(
                                      'button',
                                      {
                                        onClick: () => F(e.id),
                                        className:
                                          'px-4 py-2 rounded-lg text-sm font-medium transition '.concat(
                                            v.includes(e.id)
                            ...
                            (0, t.jsx)('button', {
                              ...
                              children: b ? 'Starting...' : 'Start Practice Session',
                            }),
                          ],
                        }),
                        (null == m ? void 0 : m.weakDomains) &&

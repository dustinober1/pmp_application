(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  ...
  {
    1100: function (e, t, r) {
      Promise.resolve().then(r.bind(r, 8416));
    },
    8146: function (e, t, r) {
      'use strict';
      r.d(t, {
    ...
    8416: function (e, t, r) {
      ...
      function c() {
        let e = (0, n.useRouter)(),
          t = (0, n.useSearchParams)().get('token'),
          [r, c] = (0, a.useState)(''),
          [l, d] = (0, a.useState)(''),
          ...
          p = async s => {
            if ((s.preventDefault(), !t)) {
              (f('Invalid or missing reset token.'), m('error'));
              return;
            }
            if (r !== l) {
              (f('Passwords do not match.'), m('error'));
              return;
            }
            if (r.length < 8) {
              (f('Password must be at least 8 characters long.'), m('error'));
              return;
            }
            (m('loading'), f(''));
            try {
              (await (0, i.Nv)('/auth/reset-password', {
                method: 'POST',
                body: { token: t, newPassword: r },
              }),
                m('success'),
                setTimeout(() => {
                  e.push('/login');
              ...
              (console.error('Password reset failed', e),
                m('error'),
                f(e.message || 'Failed to reset password. The link may have expired.'));
            }
          };
        return t
          ? 'success' === u
          ...
          : (0, s.jsxs)('div', {
              className:
                'max-w-md w-full space-y-8 bg-gray-800 p-8 rounded-xl border border-gray-700 text-center',
              children: [
                (0, s.jsx)('div', { className: 'text-5xl mb-4', children: '⚠️' }),
                (0, s.jsx)('h2', {

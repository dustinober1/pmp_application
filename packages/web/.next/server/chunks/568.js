    ...
    6568: (e, t, r) => {
      ...
      let E = a.default.forwardRef(function (e, t) {
        ...
        let C = a.default.useContext(f.RouterContext),
          ...
          w = !C,
          L = !1 !== y,
          D = null === y ? g.PrefetchKind.AUTO : g.PrefetchKind.FULL,
          { href: U, as: F } = a.default.useMemo(() => {
            if (!C) {
              let e = m(s);
              return { href: e, as: E ? m(E) : e };
            }
            let [e, t] = (0, i.resolveHref)(C, s, !0);
            return { href: e, as: E ? (0, i.resolveHref)(C, E) : t || e };
          }, [C, s, E]),
          X = a.default.useRef(U),
          k = a.default.useRef(F);
        I && (n = a.default.Children.only(r));
        let W = I ? n && 'object' == typeof n && n.ref : t,
          [G, H, Y] = (0, p.useIntersection)({ rootMargin: '200px' }),
          B = a.default.useCallback(
            e => {
              ((k.current !== F || X.current !== U) && (Y(), (k.current = F), (X.current = U)),
                G(e),
                W && ('function' == typeof W ? W(e) : 'object' == typeof W && (W.current = e)));
            },
            [F, W, U, Y, G]
          );
        a.default.useEffect(() => {}, [F, U, H, O, L, null == C ? void 0 : C.locale, M, w, D]);
        let K = {
          ref: B,
          onClick(e) {
            (I || 'function' != typeof v || v(e),
        ...
        if ((0, l.isAbsoluteUrl)(F)) K.href = F;
        else if (!I || S || ('a' === n.type && !('href' in n.props))) {
          ...
          K.href =
            t || (0, _.addBasePath)((0, c.addLocale)(F, e, null == C ? void 0 : C.defaultLocale));
        }
        return I ? a.default.cloneElement(n, K) : (0, o.jsx)('a', { ...x, ...K, children: r });
      });
      ('function' == typeof t.default || ('object' == typeof t.default && null !== t.default)) &&
        void 0 === t.default.__esModule &&
        (Object.defineProperty(t.default, '__esModule', { value: !0 }),

          ...
          let e = (0, o.useRouter)(),
            ...
            b = async () => {
              try {
                ...
                let a = t[0];
                l(a);
                let r = await (0, i.Nv)(`/teams/${a.id}/dashboard`);
            ...
            y = async e => {
              if ((e.preventDefault(), n && m)) {
                (u(!0), g(null));
                try {
                  (await (0, i.Nv)(`/teams/${n.id}/invitations`, {
                    method: 'POST',
                    body: { email: m },
                  }),
                    g({ type: 'success', message: `Invitation sent to ${m}` }),
                    h(''));
                } catch (e) {
                  (console.error('Invite failed', e),
                    g({ type: 'error', message: e.message || 'Failed to send invitation' }));
                } finally {
                  u(!1);
                }
              }
            ...
            f = async (e, t) => {
              if (n && confirm(`Are you sure you want to remove ${t} from the team?`))
                try {
                  (await (0, i.Nv)(`/teams/${n.id}/members/${e}/preserve`, { method: 'DELETE' }),
                    b());
                } catch (e) {
            ...
            v = async e => {
              if (n)
                try {
                  (await (0, i.Nv)(`/teams/${n.id}/alerts/${e}/acknowledge`, { method: 'POST' }),
                              ...
                              children: [
                                ...
                                (0, a.jsxs)('form', {
                                  ...
                                  children: [
                                    ...
                                    p &&
                                      a.jsx('div', {
                                        className: `p-3 rounded text-sm ${'success' === p.type ? 'bg-green-900/30 text-green-400' : 'bg-red-900/30 text-red-400'}`,
                                        children: p.message,
                                      }),
                                    a.jsx('button', {
                                      type: 'submit',
                                      ...
                                      children: x ? 'Sending...' : 'Send Invitation',
                                    }),
                                    (0, a.jsxs)('p', {

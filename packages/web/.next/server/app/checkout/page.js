    ...
    (e.modules = {
      ...
      9119: (e, t, s) => {
        ...
        let l = [
              ...
              children: [
                'checkout',
                {
                  children: [
                    ...
                    {
                      page: [
                        () => Promise.resolve().then(s.bind(s, 5463)),
          ...
          d = ['/Users/dustinober/Projects/pmp_application/packages/web/src/app/checkout/page.tsx'],
          u = '/checkout/page',
      ...
      9590: (e, t, s) => {
        Promise.resolve().then(s.bind(s, 6992));
      },
      1043: (e, t, s) => {
        'use strict';
        var a = s(2854);
      ...
      6992: (e, t, s) => {
        ...
        function n() {
          let e = (0, o.useRouter)(),
            t = (0, o.useSearchParams)().get('tier') || 'high-end',
            ...
            u = async () => {
              (c(!0), d(''));
              try {
                (await (0, i.Nv)('/subscriptions/upgrade-tier', {
                  method: 'POST',
                  body: { tierId: t, paymentId: `mock_pay_${Date.now()}` },
                }),
                  e.push('/dashboard?payment=success'));
              } catch (e) {
                (console.error('Checkout failed', e),
                  d(e.message || 'Payment initialization failed. Please try again.'));
              } finally {
                c(!1);
              }
            };
                ...
                (0, a.jsxs)('div', {
                  ...
                  children: [
                    (0, a.jsxs)('div', {
                      ...
                      children: [
                        a.jsx('span', { className: 'text-gray-400', children: 'Plan' }),
                        a.jsx('span', {
                    ...
                    (0, a.jsxs)('div', {
                      ...
                      children: [
                        a.jsx('span', { className: 'text-gray-400', children: 'Total' }),
                        (0, a.jsxs)('span', {
        ...
        function c() {
          return a.jsx('div', {
            ...
            children: a.jsx(r.Suspense, {
              fallback: a.jsx('div', { className: 'text-white', children: 'Loading checkout...' }),
              children: a.jsx(n, {}),
            }),
          });
        }
        ...
        function n({ children: e }) {
          let [t, s] = (0, r.useState)({
            ...
            c = async (e, t) => {
              ...
              let { accessToken: o, refreshToken: n, user: c } = r.data;
            ...
            l = async (e, t, a) => {
              ...
              let { accessToken: n, refreshToken: c, user: l } = o.data;
          ...
          return a.jsx(o.Provider, {
            value: { ...t, login: c, register: l, logout: d, refreshToken: u },
            children: e,
          });
        }
        function c() {
      ...
      7674: (e, t, s) => {
        'use strict';
        s.d(t, { Lc: () => n, Nv: () => o, Sh: () => d, kx: () => l, sA: () => i, tF: () => c });
        ...
        async function o(e, t = {}) {
          ...
          let l = await fetch(`${a}${e}`, {
              method: s,
              headers: c,
              body: o ? JSON.stringify(o) : void 0,
            }),
            d = await l.json();
          if (!l.ok) throw Error(d.error?.message || 'Request failed');
          return d;
        }
        let i = {
      ...
      5463: (e, t, s) => {
        ...
        let a = (0, s(3189).createProxy)(
          String.raw`/Users/dustinober/Projects/pmp_application/packages/web/src/app/checkout/page.tsx#default`
        );
      },
      4773: (e, t, s) => {
        'use strict';
        (s.r(t), s.d(t, { default: () => c, metadata: () => n }));
        var a = s(9013),
          r = s(5900),
          o = s.n(r);
        s(5556);

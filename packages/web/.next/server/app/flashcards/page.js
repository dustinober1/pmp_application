(() => {
  ...
  ((e.id = 643),
    ...
    (e.modules = {
              ...
              children: [
                'flashcards',
                {
                  children: [
                    ...
                    {
                      page: [
                        () => Promise.resolve().then(r.bind(r, 5393)),
      ...
      3579: (e, s, r) => {
        Promise.resolve().then(r.bind(r, 6831));
      },
      6831: (e, s, r) => {
        'use strict';
        ...
        function c() {
          let e = (0, n.useRouter)(),
            { isAuthenticated: s, isLoading: r } = (0, l.a)(),
            [c, m] = (0, a.useState)(null),
            [x, u] = (0, a.useState)(0),
            [h, p] = (0, a.useState)(!0),
            g = async s => {
              try {
                let r = await d.Lc.startSession(
                    'review' === s ? { prioritizeReview: !0, cardCount: 20 } : { cardCount: 20 }
                  ),
                  t = r.data?.sessionId;
                t && e.push(`/flashcards/session/${t}`);
              } catch (e) {
                  ...
                  (0, t.jsxs)('main', {
                    ...
                    children: [
                      (0, t.jsxs)('div', {
                        className: 'mb-8',
                        children: [
                          t.jsx('h1', { className: 'text-2xl font-bold', children: 'Flashcards' }),
                          t.jsx('p', {
                          ...
                          (0, t.jsxs)('div', {
                            ...
                            children: [
                              ...
                              t.jsx('p', {
                                ...
                                children:
                                  x > 0
                                    ? `You have ${x} cards due for review. Keep your streak going!`
                            ...
                            children: [
                              (0, t.jsxs)('div', {
                                ...
                                children: [
                                  ...
                                  t.jsx('p', { className: 'font-medium', children: 'Know It' }),
                                  t.jsx('p', {
                              ...
                              (0, t.jsxs)('div', {
                                ...
                                children: [
                                  ...
                                  t.jsx('p', { className: 'font-medium', children: 'Learning' }),
                                  t.jsx('p', {
                                    className: 'text-sm text-[var(--foreground-muted)] mt-1',
                              ...
                              (0, t.jsxs)('div', {
                                ...
                                children: [
                                  ...
                                  t.jsx('p', { className: 'font-medium', children: "Don't Know" }),
                                  t.jsx('p', {
                                    className: 'text-sm text-[var(--foreground-muted)] mt-1',
      ...
      5393: (e, s, r) => {
        ...
        let t = (0, r(3189).createProxy)(
          String.raw`/Users/dustinober/Projects/pmp_application/packages/web/src/app/flashcards/page.tsx#default`
        );
      },
    }));

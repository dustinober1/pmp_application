    ...
    (e.modules = {
      ...
      5716: (e, s, t) => {
        ...
        function l() {
            ...
            w = async s => {
              ...
              try {
                (await (0, n.Nv)(`/flashcards/sessions/${e}/responses/${t.id}`, {
                  ...
                  m < c.cards.length - 1 ? (p(!1), u(e => e + 1), y(Date.now())) : await j());
              } catch (e) {
          ...
          let P = c.cards[m],
            k = c.cards.length > 0 ? Math.round((m / c.cards.length) * 100) : 0;
          return P
            ? (0, r.jsxs)('div', {
                ...
                children: [
                      ...
                      (0, r.jsxs)('div', {
                        ...
                        children: [
                          (0, r.jsxs)('div', {
                            ...
                            children: [
                              (0, r.jsxs)('span', {
                                children: ['Card ', m + 1, ' of ', c.cards.length],
                              }),
                              (0, r.jsxs)('span', { children: [Math.round(k), '%'] }),
                            ],
                          }),
                          r.jsx('div', {
                  ...
                  r.jsx('div', {
                    ...
                    children: r.jsx('div', {
                      ...
                      onClick: v,
                      children: (0, r.jsxs)('div', {
                        className: `relative w-full h-full duration-500 transform-style-3d transition-transform ${x ? 'rotate-y-180' : ''}`,
                        children: [
                          (0, r.jsxs)('div', {
                            className:
                      ...
                      ? (0, r.jsxs)('div', {
                          ...
                          children: [
                            (0, r.jsxs)('button', {
                              ...
                              children: [
                                r.jsx('div', { className: 'font-bold mb-1', children: 'Again' }),
                                r.jsx('div', {
                            ...
                            (0, r.jsxs)('button', {
                              ...
                              children: [
                                r.jsx('div', { className: 'font-bold mb-1', children: 'Hard' }),
                                r.jsx('div', {
                                  className: 'text-xs opacity-70',
                                  children: '2 days',
                                }),
                            ...
                            (0, r.jsxs)('button', {
                              ...
                              children: [
                                r.jsx('div', { className: 'font-bold mb-1', children: 'Easy' }),
                                r.jsx('div', {
                                  className: 'text-xs opacity-70',
                                  children: '4 days',
                                }),
            ...
            : r.jsx('div', { children: 'Loading card...' });
        }
      },
      3592: (e, s, t) => {
        'use strict';

    ...
    (e.modules = {
      ...
      4767: (e, t, s) => {
        ...
        function l() {
          ...
          let $ = c.questions[m],
            I = c.questions.length > 0 ? Math.round((m / c.questions.length) * 100) : 0;
          return $
            ? (0, r.jsxs)('div', {
                ...
                children: [
                  ...
                  (0, r.jsxs)('div', {
                    ...
                    children: [
                              ...
                              return (
                                ...
                                (0, r.jsxs)(
                                  'button',
                                  {
                                    ...
                                    children: [
                                      r.jsx('div', {
                                        className: `mt-0.5 w-5 h-5 rounded-full border flex items-center justify-center mr-4 flex-shrink-0 transition-colors ${y ? (s ? 'border-green-500 bg-green-500' : a ? 'border-red-500 bg-red-500' : 'border-gray-600') : t ? 'border-primary-500 bg-primary-500' : 'border-gray-500 group-hover:border-gray-400'}`,
                                        children:
                                          (y && (s || a)) || t
                                            ? r.jsx('div', {
                                      ...
                                      r.jsx('span', {
                                        className: `text-base ${y && (s || a) ? 'text-white' : 'text-gray-300'}`,
                                        children: e.text,
                                      }),
                                    ],
                                  },
                      ...
                      y &&
                        (0, r.jsxs)('div', {
                          className: `rounded-xl p-6 mb-6 border animate-in fade-in slide-in-from-bottom-4 duration-300 ${y.isCorrect ? 'bg-green-900/20 border-green-800' : 'bg-red-900/20 border-red-800'}`,
                          children: [
                            r.jsx('div', {
                              className: 'flex items-center mb-3',
                              children: r.jsx('span', {
                                className: `text-2xl mr-3 ${y.isCorrect ? 'text-green-400' : 'text-red-400'}`,
                                children: y.isCorrect ? '✓ Correct' : '✗ Incorrect',
                              }),
                            }),
                            (0, r.jsxs)('div', {

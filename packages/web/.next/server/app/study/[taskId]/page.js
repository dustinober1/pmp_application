    ...
    (e.modules = {
      ...
      930: (e, t, n) => {
        ...
        let u = [
                  ...
                  children: [
                    '[taskId]',
                    {
                      children: [
                        ...
                        {
                          page: [
                            () => Promise.resolve().then(n.bind(n, 7965)),
            ...
            {
              layout: [
                () => Promise.resolve().then(n.bind(n, 4773)),
          ...
          f = new r.AppPageRouteModule({
            definition: {
              kind: i.x.APP_PAGE,
              page: '/study/[taskId]/page',
              pathname: '/study/[taskId]',
              bundlePath: '',
              filename: '',
              appPaths: [],
            },
      ...
      5653: (e, t, n) => {
        Promise.resolve().then(n.bind(n, 4076));
      },
      3088: (e, t, n) => {
        Promise.resolve().then(n.bind(n, 3658));
      },
      1345: e => {
        'use strict';
            ...
            if (((t = arguments[d]), null != t))
              for (n in t)
                ((r = s(p, n)),
                  p !== (i = s(t, n)) &&
                    (h && i && (o(i) || (u = l(i)))
                      ? (u ? ((u = !1), (c = r && l(r) ? r : [])) : (c = r && o(r) ? r : {}),
                        a(p, { name: n, newValue: e(h, c, i) }))
                      : void 0 !== i && a(p, { name: n, newValue: i })));
          return p;
        };
      },
      1627: e => {
        ...
        e.exports = function (e, s) {
          ...
          function h(e) {
            ((this.start = e), (this.end = { line: c, column: p }), (this.source = s.source));
          }
          function m(t) {
            var n = Error(s.source + ':' + c + ':' + p + ': ' + t);
            if (
              ((n.reason = t),
              (n.filename = s.source),
              (n.line = c),
              ...
              for (
                ...
                (e = (function () {
                  var e = f(),
                    n = g(i);
                  if (n) {
                    if ((x(), !g(l))) return m("property missing ':'");
                    var r = g(o),
                      s = e({
                        type: 'declaration',
      ...
      1203: (e, t) => {
        ...
        t.camelCase = function (e, t) {
          ...
          return (void 0 === t && (t = {}), !(u = e) || i.test(u) || n.test(u))
            ? e
            : ((e = e.toLowerCase()),
              (e = t.reactCompat ? e.replace(o, s) : e.replace(l, s)).replace(r, a));
        };
      },
      9514: function (e, t, n) {
        'use strict';
      ...
      4076: (e, t, n) => {
        ...
        class a {
          ...
          async queueAction(e, t) {
            let n = { id: crypto.randomUUID(), type: e, payload: t, timestamp: Date.now() };
            (this.queue.push(n), this.saveQueue(), navigator.onLine && (await this.sync()));
          }
          async sync() {
            ...
            let e = [],
              t = [...this.queue];
            for (let n of (console.log(`[Sync] Processing ${t.length} actions...`), t))
              try {
                await this.processAction(n);
              } catch (t) {
                (console.error(`[Sync] Failed to process action ${n.id}`, t), e.push(n));
              }
            ((this.queue = e),
              this.saveQueue(),
              (this.isSyncing = !1),
          ...
          async processAction(e) {
            switch (e.type) {
              case 'MARK_SECTION_COMPLETE':
                await (0, l.Nv)(`/study/sections/${e.payload.sectionId}/complete`, {
                  method: 'POST',
                });
                break;
              case 'SUBMIT_FLASHCARD_RESULT':
                await (0, l.Nv)(`/flashcards/${e.payload.flashcardId}/review`, {
                  method: 'POST',
        ...
        function s({ children: e }) {
          return r.jsx(i.H, { children: e });
        }
        new a();
      },
      3658: (e, t, n) => {
        'use strict';
        (n.r(t), n.d(t, { default: () => nj }));
        var r = {};
        (n.r(r),
          n.d(r, {
            boolean: () => v,
        ...
        var l = n(3227),
          ...
          s = n(2278);
        n(7674);
        let u = /^[$_\p{ID_Start}][$_\u{200C}\u{200D}\p{ID_Continue}]*$/u,
          c = /^[$_\p{ID_Start}][-$_\u{200C}\u{200D}\p{ID_Continue}]*$/u,
          p = {};
        function d(e, t) {
          return ((t || p).jsx ? c : u).test(e);
        }
        let f = /[ \t\n\f\r]/g;
        function h(e) {
          return '' === e.replace(f, '');
        ...
        function D(e) {
          ...
          for (let [r, i] of Object.entries(e.properties)) {
            let l = new I(r, e.transform(e.attributes || {}, r), i, e.space);
                      ...
                      if ('children' !== r && en.call(t.properties, r)) {
                        let l = (function (e, t, n) {
                          let r = (function (e, t) {
                            ...
                            if (n.length > 4 && 'data' === n.slice(0, 4) && V.test(t)) {
                              if ('-' === t.charAt(4)) {
                                let e = t.slice(5).replace(U, $);
                                ...
                                'object' == typeof n
                                  ...
                                  : (function (e, t) {
                                      try {
                                        ...
                                        let t = new et('Cannot parse `style` attribute', {
                                        ...
                                        throw (
                                          ...
                                          (t.url = ea + '#cannot-parse-style-attribute'),
                                          t
                                        );
                                      }
                                    })(e, String(n));
                ...
                return (
                  el.has(t.tagName) &&
                    (a = a.filter(function (e) {
                      return (
                        'string' != typeof e ||
                        !('object' == typeof e ? 'text' === e.type && h(e.value) : h(e))
                      );
                    })),
                  eu(e, o, l, t),
                  ec(o, a),
            ...
            : 'mdxFlowExpression' === t.type || 'mdxTextExpression' === t.type
              ...
              : 'mdxJsxFlowElement' === t.type || 'mdxJsxTextElement' === t.type
                ? (function (e, t, n) {
                    let r = e.schema,
                      i = r;
                    ('svg' === t.name && 'html' === r.space && ((i = _), (e.schema = i)),
                      e.ancestors.push(t));
                    let l = null === t.name ? e.Fragment : ed(e, t.name, !0),
                      o = (function (e, t) {
                        let n = {};
                ...
                : 'mdxjsEsm' === t.type
                  ...
                  : 'root' === t.type
                    ? (function (e, t, n) {
                        let r = {};
                        return (ec(r, ep(e, t)), e.create(t, e.Fragment, r, n));
                      })(e, t, n)
                    : 'text' === t.type
                      ? t.value
                      : void 0;
                ...
                (Object.assign(
                  ...
                  (function (e, t) {
                    ...
                    for (c.reverse(), d = -1; ++d < c.length; )
                      ((p[h + c[d][0]] = h + c[d][1]), (h += c[d][1] - c[d][0] - 1));
                    return p;
                  })(c, u)
                ),
                (u = s[u]),
        ...
        function eM(e, t, n, r) {
          ...
          return function (r) {
            return eO(r)
              ? (e.enter(n),
                (function r(o) {
                  return eO(o) && l++ < i ? (e.consume(o), r) : (e.exit(n), t(o));
                })(r))
              : t(r);
          };
        }
        let eF = {
            ...
            tokenize: function (e) {
              ...
              function s(e) {
                if ((o++, i.containerState._closeFlow)) {
                  ...
                  return (eb(i.events, l + 1, 0, i.events.slice(r)), (i.events.length = a), u(e));
                }
                return a(e);
              }
              function u(n) {
                ...
                return ((i.containerState = {}), e.check(eB, c, p)(n));
              }
              function c(e) {
                return (t && y(), g(o), d(e));
              }
              ...
              function d(t) {
                return ((i.containerState = {}), e.attempt(eB, f, h)(t));
              }
              function f(e) {
              ...
              function m(e, l) {
                ...
                if (
                  ...
                  (eb(i.events, s + 1, 0, i.events.slice(a)), (i.events.length = l));
                }
              }
              function g(t) {
                let n = l.length;
          ...
          eU = {
            ...
            tokenize: function (e, t, n) {
              return function (t) {
                return eO(t) ? eM(e, r, 'linePrefix')(t) : r(t);
              };
              function r(e) {
          ...
          eV = {
            ...
            tokenize: function (e, t) {
              ...
              function r(t) {
                return null === t ? i(t) : eL(t) ? e.check(eH, l, i)(t) : (e.consume(t), r);
              }
              function i(n) {
              ...
              let t = this,
                n = e.attempt(
                  ...
                  e.attempt(
                    ...
                    r,
                    eM(e, e.attempt(this.parser.constructs.flow, r, e.attempt(eV, r)), 'linePrefix')
                  )
                );
              return n;
              function r(r) {
        ...
        function eQ(e) {
          return {
            resolveAll: eW('text' === e ? eK : void 0),
            tokenize: function (t) {
              let n = this,
              ...
              tokenize: function (e, t, n) {
                ...
                return (
                  ...
                  e.check(
                    ...
                    function (n) {
                      return r.containerState.furtherBlankLines || !eO(n)
            ...
            tokenize: function (e, t, n) {
              ...
              function a(t) {
                return (
                  ...
                  e.check(eU, r.interrupt ? n : s, e.attempt(e0, c, u))
                );
              }
              function s(e) {
            ...
            tokenize: function (e, t, n) {
              ...
              return eM(
                ...
                function (e) {
                  ...
                  return !eO(e) && i && 'listItemPrefixWhitespace' === i[1].type ? t(e) : n(e);
                },
        ...
        function e4(e, t, n, r, i, l, o, a, s) {
          let u = s || Number.POSITIVE_INFINITY,
            c = 0;
          return function (t) {
            return 60 === t
              ? (e.enter(r), e.enter(i), e.enter(l), e.consume(t), e.exit(l), p)
              : null === t || 32 === t || 41 === t || eq(t)
                ? n(t)
                : (e.enter(r),
                  e.enter(o),
                  e.enter(a),
        ...
        function e3(e, t, n, r, i, l) {
          ...
          function u(p) {
            return s > 999 ||
              ...
              91 === p ||
              (93 === p && !o) ||
              (94 === p && !s && '_hiddenFootnoteSupport' in a.parser.constructs)
              ? n(p)
              : 93 === p
          ...
          function c(t) {
            return null === t || 91 === t || 93 === t || eL(t) || s++ > 999
              ...
              : (e.consume(t), o || (o = !eO(t)), 92 === t ? p : c);
          }
          function p(t) {
            return 91 === t || 92 === t || 93 === t ? (e.consume(t), s++, c) : c(t);
          }
        }
        function e6(e, t, n, r, i, l) {
          let o;
          return function (t) {
        ...
        let e7 = {
            ...
            tokenize: function (e, t, n) {
              ...
              function i(t) {
                return eO(t) ? eM(e, l, 'whitespace')(t) : l(t);
              }
              function l(e) {
                return null === e || eL(e) ? t(e) : n(e);
              }
            ...
            tokenize: function (e, t, n) {
              ...
              return function (t) {
                return (function (t) {
                  ...
                  return (
                    (o =
                      l && 'linePrefix' === l[1].type ? l[2].sliceSerialize(l[1], !0).length : 0),
                    (r = t),
                    e.enter('codeFenced'),
                    e.enter('codeFencedFence'),
                    e.enter('codeFencedFenceSequence'),
              ...
              function s(l) {
                return null === l || eL(l)
                  ? (e.exit('codeFencedFence'), i.interrupt ? t(l) : e.check(to, c, h)(l))
              ...
              function c(t) {
                return e.attempt(l, h, p)(t);
              }
              function p(t) {
                return (e.enter('lineEnding'), e.consume(t), e.exit('lineEnding'), d);
              }
              function d(t) {
                return o > 0 && eO(t) ? eM(e, f, 'linePrefix', o + 1)(t) : f(t);
              }
              function f(t) {
                return null === t || eL(t)
                  ? e.check(to, c, h)(t)
            ...
            tokenize: function (e, t, n) {
              ...
              function a(t) {
                return 35 === t
                  ? (e.enter('characterReferenceMarkerNumeric'),
                    ...
                    s)
                  : (e.enter('characterReferenceValue'), (r = 31), (i = eC), u(t));
              }
              function s(t) {
                return 88 === t || 120 === t
              ...
              function u(a) {
                if (59 === a && o) {
                  ...
                  return i !== eC || tc(l.sliceSerialize(r))
                    ? (e.enter('characterReferenceMarker'),
                      e.consume(a),
                      e.exit('characterReferenceMarker'),
        ...
        let tm = {
            ...
            resolveTo: function (e, t) {
              ...
              return (
                ...
                (l = ev(l, [['enter', c, t]])),
                (l = ev(l, th(t.parser.constructs.insideSpan.null, e.slice(r + a + 4, i - 3), t))),
                (l = ev(l, [['exit', c, t], e[i - 2], e[i - 1], ['exit', u, t]])),
                (l = ev(l, e.slice(i + 1))),
                (l = ev(l, [['exit', s, t]])),
                eb(e, r, e.length, l),
                e
            ...
            tokenize: function (e, t, n) {
                ...
                return r
                  ? r._inactive
                    ...
                    : ((i = l.parser.defined.includes(
                        e9(l.sliceSerialize({ start: r.end, end: l.now() }))
                      )),
                      e.enter('labelEnd'),
                      e.enter('labelMarker'),
                      e.consume(t),
              ...
              function a(t) {
                return 40 === t
                  ? e.attempt(tg, u, i ? u : c)(t)
                  : 91 === t
                    ? e.attempt(ty, u, i ? s : c)(t)
                    : i
                      ? u(t)
                      : c(t);
              }
              function s(t) {
                return e.attempt(tx, u, c)(t);
              }
              function u(e) {
                return t(e);
              }
          ...
          tg = {
            tokenize: function (e, t, n) {
              ...
              function a(t) {
                return 34 === t || 39 === t || 40 === t
                  ? e6(e, s, n, 'resourceTitle', 'resourceTitleMarker', 'resourceTitleString')(t)
                  : u(t);
              }
              function s(t) {
                return eN(t) ? e5(e, u)(t) : u(t);
              }
              function u(r) {
                return 41 === r
                  ? (e.enter('resourceMarker'),
          ...
          ty = {
            tokenize: function (e, t, n) {
              let r = this;
              return function (t) {
                return e3.call(r, e, i, l, 'reference', 'referenceMarker', 'referenceString')(t);
              };
              function i(e) {
        ...
        function tv(e) {
          return null === e || eN(e) || ej(e) ? 1 : eR(e) ? 2 : void 0;
        }
        let tk = {
          name: 'attention',
                ...
                for (n = c; n--; )
                  if (
                    ...
                    (tw(p, -a),
                      ...
                      (s = ev(s, th(t.parser.constructs.insideSpan.null, e.slice(n + 1, c), t))),
                      (s = ev(s, [
                        ['exit', i, t],
                        ['enter', o, t],
                        ['exit', o, t],
              ...
              return (
                ...
                (function o(a) {
                  ...
                  let s = e.exit('attentionSequence'),
                    ...
                    p = !l || (2 === l && u) || r.includes(i);
                  return (
                    (s._open = !!(42 === n ? c : c && (l || !p))),
                    (s._close = !!(42 === n ? p : p && (u || !c))),
                    t(a)
                  );
                })(o)
              );
        ...
        let tS = {
          ...
          tT = {
            91: {
              ...
              tokenize: function (e, t, n) {
                ...
                function l(t) {
                  return ((r = e9(i.sliceSerialize(i.events[i.events.length - 1][1]).slice(1, -1))),
                  58 === t)
                    ? (e.enter('definitionMarker'), e.consume(t), e.exit('definitionMarker'), o)
                    : n(t);
                }
                function o(t) {
                  return eN(t) ? e5(e, a)(t) : a(t);
                }
                function a(t) {
                  return e4(
                    e,
                ...
                function s(t) {
                  return e.attempt(e7, u, u)(t);
                }
                function u(t) {
                  return eO(t) ? eM(e, c, 'whitespace')(t) : c(t);
                }
                function c(l) {
                  return null === l || eL(l)
          ...
          tP = {
            ...
            60: {
              ...
              tokenize: function (e, t, n) {
                ...
                function u(o) {
                  return 33 === o
                    ...
                    : 47 === o
                      ? (e.consume(o), (i = !0), f)
                      : 63 === o
                        ? (e.consume(o), (r = 3), s.interrupt ? t : L)
                        : eT(o)
                ...
                function f(t) {
                  return eT(t) ? (e.consume(t), (l = String.fromCharCode(t)), h) : n(t);
                }
                function h(o) {
                  if (null === o || 47 === o || 62 === o || eN(o)) {
                    let a = 47 === o,
                      u = l.toLowerCase();
                    return !a && !i && tr.includes(u)
                      ? ((r = 1), s.interrupt ? t(o) : E(o))
                      : tn.includes(l.toLowerCase())
                        ? ((r = 6), a)
                          ? (e.consume(o), m)
                          : s.interrupt
                            ? t(o)
                ...
                function y(t) {
                  return 45 === t || 46 === t || 58 === t || 95 === t || eC(t)
                    ? (e.consume(t), y)
                    : x(t);
                }
                function x(t) {
                  return 61 === t ? (e.consume(t), b) : eO(t) ? (e.consume(t), x) : g(t);
                }
                function b(t) {
                ...
                function k(e) {
                  return 47 === e || 62 === e || eO(e) ? g(e) : n(e);
                }
                function w(t) {
                  return 62 === t ? (e.consume(t), S) : n(t);
                }
                function S(t) {
                  return null === t || eL(t) ? E(t) : eO(t) ? (e.consume(t), S) : n(t);
                }
                function E(t) {
                  return 45 === t && 2 === r
                    ? (e.consume(t), q)
                      ...
                      : 62 === t && 4 === r
                        ...
                        : 63 === t && 3 === r
                          ...
                          : 93 === t && 5 === r
                            ? (e.consume(t), A)
                            : eL(t) && (6 === r || 7 === r)
                              ? (e.exit('htmlFlowData'), e.check(ti, O, T)(t))
                              : null === t || eL(t)
                                ? (e.exit('htmlFlowData'), T(t))
                                : (e.consume(t), E);
                }
                function T(t) {
                  return e.check(tl, C, O)(t);
                }
                function C(t) {
                  return (e.enter('lineEnding'), e.consume(t), e.exit('lineEnding'), P);
                }
                function P(t) {
                  return null === t || eL(t) ? T(t) : (e.enter('htmlFlowData'), E(t));
                }
                function q(t) {
                  return 45 === t ? (e.consume(t), L) : E(t);
                }
                function I(t) {
                ...
                function D(t) {
                  if (62 === t) {
                    let n = l.toLowerCase();
                    return tr.includes(n) ? (e.consume(t), N) : E(t);
                  }
                  return eT(t) && l.length < 8
                ...
                function N(t) {
                  return null === t || eL(t) ? (e.exit('htmlFlowData'), O(t)) : (e.consume(t), N);
                }
                function O(n) {
          ...
          tI = {
            ...
            60: [
              {
                ...
                tokenize: function (e, t, n) {
                  ...
                  function i(t) {
                    return eT(t) ? (e.consume(t), l) : 64 === t ? n(t) : a(t);
                  }
                  function l(t) {
                    return 43 === t || 45 === t || 46 === t || eC(t)
                      ? ((r = 1),
                        (function t(n) {
                          return 58 === n
                            ? (e.consume(n), (r = 0), o)
                            : (43 === n || 45 === n || 46 === n || eC(n)) && r++ < 32
                              ? (e.consume(n), t)
                              : ((r = 0), a(n));
                        })(t))
                      : a(t);
                  ...
                  function o(r) {
                    return 62 === r
                      ? (e.exit('autolinkProtocol'),
                        ...
                        e.exit('autolink'),
                        t)
                      : null === r || 32 === r || 60 === r || eq(r)
                        ? n(r)
                        : (e.consume(r), o);
                  }
                  function a(t) {
                    return 64 === t ? (e.consume(t), s) : eP(t) ? (e.consume(t), a) : n(t);
                  }
                  function s(i) {
                    return eC(i)
                      ? (function i(l) {
              ...
              },
              {
                ...
                tokenize: function (e, t, n) {
                  ...
                  function d(e) {
                    return 62 === e ? I(e) : 45 === e ? p(e) : c(e);
                  }
                  function f(t) {
                    let r = 'CDATA[';
                    return t === r.charCodeAt(i++) ? (e.consume(t), i === r.length ? h : f) : n(t);
                  }
                  function h(t) {
                    return null === t
                      ? n(t)
                  ...
                  function v(t) {
                    return eT(t) ? (e.consume(t), k) : n(t);
                  }
                  function k(t) {
                    return 45 === t || eC(t)
                      ? (e.consume(t), k)
                      : (function t(n) {
                          return eL(n) ? ((l = t), D(n)) : eO(n) ? (e.consume(n), t) : I(n);
                        })(t);
                  }
                  function w(t) {
                    return 45 === t || eC(t)
            ...
            96: {
              ...
              previous: function (e) {
                return (
                  96 !== e || 'characterEscape' === this.events[this.events.length - 1][1].type
                );
              },
              resolve: function (e) {
                let t,
        ...
        let tR = /\\([!-/:-@[-`{-~])|&(#(?:\d{1,7}|x[\da-f]{1,6})|[\da-z]{1,31});/gi;
        function tj(e, t, n) {
          if (t) return t;
            ...
            return (
              ...
              (function (e) {
                let t = {
                  ...
                  exit: {
                    ...
                    characterReference: function (e) {
                      this.stack.pop().position.end = tM(e.end);
                    },
                    ...
                    definitionLabelString: function (e) {
                      ...
                      ((n.label = t), (n.identifier = e9(this.sliceSerialize(e)).toLowerCase()));
                    },
                    ...
                    labelText: function (e) {
                      ...
                      ((n.label = t.replace(tR, tj)), (n.identifier = e9(t).toLowerCase()));
                    },
                    lineEnding: function (e) {
                      let n = this.stack[this.stack.length - 1];
                      if (this.data.atHardBreak) {
                        ((n.children[n.children.length - 1].position.end = tM(e.end)),
                ...
                return function (e) {
                  ...
                  for (
                    r.position = {
                      start: tM(e.length > 0 ? e[0][1].start : { line: 1, column: 1, offset: 0 }),
                      end: tM(
                ...
                function l(e, t, n) {
                  (this.stack[this.stack.length - 1].children.push(e),
                    ...
                    (e.position = { start: tM(t.start), end: void 0 }));
                }
                function o(e) {
                  return function (t) {
                ...
                function a(e, t) {
                  ...
                  if (r)
                    r[0].type !== e.type &&
                      (t ? t.call(this, e, r[0]) : (r[1] || tF).call(this, e, r[0]));
                  else
                    throw Error(
                      'Cannot close `' +
                        e.type +
                  ...
                  n.position.end = tM(e.end);
                }
                function s() {
                  return ey(
                    this.stack.pop(),
                    'boolean' != typeof eg.includeImageAlt || eg.includeImageAlt,
                    'boolean' != typeof eg.includeHtml || eg.includeHtml
                  );
                }
                function u(e) {
                ...
                function c(e) {
                  ...
                  ((t.value += this.sliceSerialize(e)), (t.position.end = tM(e.end)));
                }
                function p() {
                      ...
                      constructs: (function (e) {
                        ...
                        for (; ++n < e.length; )
                          (function (e, t) {
                            ...
                            for (n in t) {
                              let r;
                              let i = (eE.call(e, n) ? e[n] : void 0) || (e[n] = {}),
                                l = t[n];
                              if (l)
                                for (r in l) {
                                  eE.call(i, r) || (i[r] = []);
                        ...
                        return (function (e, t, n) {
                          let r = {
                            ...
                            u = {
                              ...
                              write: function (e) {
                                ...
                                null !== o[o.length - 1])
                                  ? []
                                  : (m(t, 0), (u.events = th(l, u.events, u)), u.events);
                              },
                            },
                          ...
                          function h(e, t) {
                            return function (n, i, l) {
                              ...
                              function h(e) {
                                return ((o = e), (c = 0), 0 === e.length) ? l : m(e[c]);
                              }
                              function m(e) {
                                return function (n) {
                                  return ((f = (function () {
                              ...
                              function x(e) {
                                return (f.restore(), ++c < o.length) ? m(o[c]) : l;
                              }
                            };
                          }
                          function m(e, t) {
                      ...
                      function (e, t, n) {
                        ...
                        for (
                          e =
                            ...
                            l = 0,
                            s = '',
                            u && (65279 === e.charCodeAt(0) && l++, (u = void 0));
                          l < e.length;
                        ) {
                          if (
                            ((tN.lastIndex = l),
                            (c = (r = tN.exec(e)) && void 0 !== r.index ? r.index : e.length),
                            (p = e.charCodeAt(c)),
                            !r)
                          ) {
                            s = e.slice(l);
                          ...
                          if (10 === p && l === c && o) (d.push(-3), (o = void 0));
                          else
                            switch (
                              (o && (d.push(-5), (o = void 0)),
                              l < c && (d.push(e.slice(l, c)), (a += c - l)),
                              p)
                            ) {
                              case 0:
                                (d.push(65533), a++);
                                break;
                              case 9:
                                for (i = 4 * Math.ceil(a / 4), d.push(-2); a++ < i; ) d.push(-1);
                                break;
                              case 10:
                                (d.push(-4), (a = 1));
                                break;
                        ...
                        return (n && (o && d.push(-5), s && d.push(s), d.push(null)), d);
                      })(n, r, !0)
                    )
                )
              )
        ...
        let tB = 'object' == typeof self ? self : globalThis,
          tU = (e, t) => {
              ...
              l = r => {
                ...
                switch (o) {
                  ...
                  case 2: {
                    ...
                    let n = [],
                      s = i([o, n], r);
                    for (let t of t$(r)) (e || !tY(tG(r[t]))) && n.push([l(t), l(r[t])]);
                    return s;
                  }
                  case 3:
                  ...
                  case 5: {
                    let t = [],
                      n = i([o, t], r);
                    for (let [n, i] of r) (e || !(tY(tG(n)) || tY(tG(i)))) && t.push([l(n), l(i)]);
                    return n;
                  }
                  case 6: {
                    let t = [],
                      n = i([o, t], r);
                    for (let n of r) (e || !tY(tG(n))) && t.push(l(n));
                    return n;
                  }
                }
                let { message: s } = r;
                return i([o, { name: a, message: s }], r);
              };
            return l;
          },
          tQ = (e, { json: t, lossy: n } = {}) => {
            let r = [];
            return (tJ(!(t || n), !!t, new Map(), r)(e), r);
          },
          tW =
            'function' == typeof structuredClone
              ? (e, t) => (t && ('json' in t || 'lossy' in t) ? tV(tQ(e, t)) : structuredClone(e))
              : (e, t) => tV(tQ(e, t));
        function tK(e) {
          let t = [],
            n = -1,
        ...
        let t0 = function (e) {
          if (null == e) return t2;
          if ('function' == typeof e) return t1(e);
          if ('object' == typeof e)
            return Array.isArray(e)
              ? (function (e) {
                  let t = [],
                    n = -1;
                  for (; ++n < e.length; ) t[n] = t0(e[n]);
              ...
              (function e(i, a, s) {
                ...
                if ('string' == typeof u.type) {
                  ...
                  Object.defineProperty(c, 'name', {
                    value: 'node (\x1b[33m' + i.type + (e ? '<' + e + '>' : '') + '\x1b[39m)',
                  });
                }
                return c;
                function c() {
                  ...
                  let c,
                    ...
                    f = t4;
                  if (
                    (!t || l(i, a, s[s.length - 1] || void 0)) &&
                    !1 ===
                      (f = Array.isArray((u = n(i, s)))
                        ? u
                        : 'number' == typeof u
                          ? [!0, u]
                          : null == u
                    ...
                    return f;
                  if ('children' in i && i.children && i.children && 'skip' !== f[0])
                    for (
                      p = (r ? i.children.length : -1) + o, d = s.concat(i);
                      p > -1 && p < i.children.length;
                    ) {
                      if (!1 === (c = e(i.children[p], p, d)())[0]) return c;
                      p = 'number' == typeof c[1] ? c[1] : p + o;
                    }
                  return f;
                }
              })(e, void 0, [])();
            ...
            let n = {
              ...
              value: (function (e) {
                let t = String(e),
                  ...
                  l = [];
                for (; r; )
                  (l.push(t9(t.slice(i, r.index), i > 0, !0), r[0]),
                    (i = r.index + r[0].length),
                    (r = n.exec(t)));
                return (l.push(t9(t.slice(i), i > 0, !1)), l.join(''));
              })(String(t.value)),
            };
            return (e.patch(t, n), e.applyData(t, n));
          },
        ...
        function nr(e, t) {
          ...
          if (e && e.data) {
            ...
            ('string' == typeof t &&
              ...
              'element' === n.type && i && Object.assign(n.properties, tW(i)),
              ...
              let n = t || nt,
                ...
                l = {
                      ...
                      for (; ++r < n.length; ) {
                        ...
                        if (i) {
                          if (
                            r &&
                            'break' === n[r - 1].type &&
                            (Array.isArray(i) || 'text' !== i.type || (i.value = nl(i.value)),
                            !Array.isArray(i) && 'element' === i.type)
                          ) {
                            let e = i.children[0];
                            e && 'text' === e.type && (e.value = nl(e.value));
                          }
                  ...
                  one: function (e, t) {
                    let n = e.type,
                      r = l.handlers[n];
                    if (ne.call(l.handlers, n) && r) return r(l, e, t);
                    ...
                    return (
                      ...
                      function (e, t) {
                        let n = t.data || {},
                          r =
                            'value' in t && !(ne.call(n, 'hProperties') || ne.call(n, 'hChildren'))
                  ...
                  children: [
                    {
                      type: 'element',
                      tagName: l,
                      properties: { ...tW(o), id: 'footnote-label' },
        ...
        let np = require('node:path'),
          nd = require('node:process');
        function nf(e) {
          return !!(
            null !== e &&
            'object' == typeof e &&
        ...
        let nh = require('node:url'),
          nm = ['history', 'path', 'basename', 'stem', 'extname', 'dirname'];
        class ng {
          constructor(e) {
            let t, n;
            ((t = e
          ...
          get basename() {
            return 'string' == typeof this.path ? np.basename(this.path) : void 0;
          }
          set basename(e) {
            (nx(e, 'basename'), ny(e, 'basename'), (this.path = np.join(this.dirname || '', e)));
          }
          get dirname() {
            return 'string' == typeof this.path ? np.dirname(this.path) : void 0;
          }
          set dirname(e) {
            (nb(this.basename, 'dirname'), (this.path = np.join(e || '', this.basename)));
          }
          get extname() {
            return 'string' == typeof this.path ? np.extname(this.path) : void 0;
          }
          set extname(e) {
            ...
            this.path = np.join(this.dirname, this.stem + (e || ''));
          }
          get path() {
            return this.history[this.history.length - 1];
          }
          set path(e) {
            (nf(e) && (e = (0, nh.fileURLToPath)(e)),
              nx(e, 'path'),
              this.path !== e && this.history.push(e));
          }
          get stem() {
            return 'string' == typeof this.path ? np.basename(this.path, this.extname) : void 0;
          }
          set stem(e) {
            (nx(e, 'stem'),
              ny(e, 'stem'),
              (this.path = np.join(this.dirname || '', e + (this.extname || ''))));
          }
          fail(e, t, n) {
        ...
        function ny(e, t) {
          if (e && e.includes(np.sep))
            throw Error('`' + t + '` cannot be a path: did not expect `' + np.sep + '`');
        }
        function nx(e, t) {
        ...
        class nw extends nv {
          ...
          copy() {
            ...
            return (e.data(nu(!0, {}, this.namespace)), e);
          }
          data(e, t) {
            return 'string' == typeof e
              ? 2 == arguments.length
                ? (nC('data', this.frozen), (this.namespace[e] = t), this)
                : (nk.call(this.namespace, e) && this.namespace[e]) || void 0
              : e
          ...
          process(e, t) {
            ...
            return (
              ...
              nT('process', this.compiler || this.Compiler),
            ...
            function r(r, i) {
              ...
              n.run(o, l, function (e, t, r) {
                ...
                ('string' == typeof i ||
                (i && 'object' == typeof i && 'byteLength' in i && 'byteOffset' in i)
                  ? (r.value = i)
                  : (r.result = i),
                  a(e, r));
              });
          ...
          processSync(e) {
            ...
            return (
              ...
              nT('processSync', this.compiler || this.Compiler),
              this.process(e, function (e, r) {
                ((n = !0), ns(e), (t = r));
              }),
              nq('processSync', 'process', n),
              t
            );
          }
          run(e, t, n) {
          ...
          stringify(e, t) {
            ...
            return (nT('stringify', r), nP(e), r(e, n));
          }
          use(e, ...t) {
            ...
            function i(e) {
              ...
              (l(e.plugins), e.settings && (r.settings = nu(!0, r.settings, e.settings)));
            }
            function l(e) {
              let t = -1;
              if (null == e);
            ...
            function o(e, t) {
              ...
              if (-1 === i) n.push([e, ...t]);
                ...
                let [r, ...l] = t,
                  o = n[i][1];
                (nc(o) && nc(r) && (r = nu(!0, o, r)), (n[i] = [e, r, ...l]));
              }
            }
          }
        }
        let nS = new nw().freeze();
        function nE(e, t) {
        ...
        function nI(e) {
          return e && 'object' == typeof e && 'message' in e && 'messages' in e ? e : new ng(e);
        }
        let nD = [],
          nA = { allowDangerousHtml: !0 },
          nL = /^(https?|ircs?|mailto|xmpp)$/i,
          nN = [
        ...
        function nO(e) {
          let t = (function (e) {
              let t = e.rehypePlugins || nD,
                n = e.remarkPlugins || nD,
                r = e.remarkRehypeOptions ? { ...e.remarkRehypeOptions, ...nA } : nA;
              return nS().use(t_).use(n).use(na, r).use(t);
            })(e),
            n = (function (e) {
              let t = e.children || '',
                n = new ng();
          ...
          return (function (e, t) {
            let n = t.allowedElements,
              ...
              u = t.urlTransform || nR;
            for (let e of nN) Object.hasOwn(t, e.from) && (e.from, e.to && e.to, e.id);
            return (
              t3(e, function (e, t, i) {
                                    ...
                                    ? p.sections.map(e =>
                                        l.jsx(
                                          'button',
                                          {
                                            ...
                                            className: `w-full text-left px-3 py-2 text-sm rounded-md transition-colors ${f === e.id ? 'bg-primary-900/30 text-primary-400 border-l-2 border-primary-500' : 'text-gray-400 hover:bg-gray-800 hover:text-white'}`,
                                            children: e.title,
                                          },
                                          e.id
                                        )
                                    ...
                                    children: [
                                      ...
                                      (0, l.jsxs)('button', {
                                        ...
                                        className:
                                          'w-full text-left px-3 py-2 text-sm text-gray-400 hover:text-white hover:bg-gray-800 rounded-md transition flex items-center',
                                        children: [
                                          l.jsx('span', { className: 'mr-2', children: '∑' }),
                                          ' Related Formulas',
                                        ],
                                      }),
                                    ],
                                      ...
                                      children: (0, l.jsxs)('div', {
                                        ...
                                        children: [
                                          ...
                                          l.jsx('div', {
                                            ...
                                            children: l.jsx(nO, { children: e.content }),
                                          }),
                                        ],
                                      }),
                                    },
      ...
      2278: (e, t, n) => {
        ...
        function a({ children: e }) {
          let [t, n] = (0, i.useState)({
            ...
            s = async (e, t) => {
              let r = await fetch(`${o}/auth/login`, {
                ...
                i = await r.json();
              if (!r.ok) throw Error(i.error?.message || 'Login failed');
              let { accessToken: l, refreshToken: a, user: s } = i.data;
              (localStorage.setItem('accessToken', l),
                localStorage.setItem('refreshToken', a),
                n({ user: s, token: l, isLoading: !1, isAuthenticated: !0 }));
            },
            u = async (e, t, r) => {
              let i = await fetch(`${o}/auth/register`, {
                  method: 'POST',
                  headers: { 'Content-Type': 'application/json' },
                  body: JSON.stringify({ email: e, password: t, name: r }),
                }),
                l = await i.json();
              if (!i.ok) throw Error(l.error?.message || 'Registration failed');
              let { accessToken: a, refreshToken: s, user: u } = l.data;
              (localStorage.setItem('accessToken', a),
                localStorage.setItem('refreshToken', s),
                n({ user: u, token: a, isLoading: !1, isAuthenticated: !0 }));
            },
            c = () => {
            ...
            p = async () => {
              ...
              try {
                ...
                if (t.ok) {
                  let { accessToken: e, refreshToken: n } = (await t.json()).data;
          ...
          return r.jsx(l.Provider, {
            value: { ...t, login: s, register: u, logout: c, refreshToken: p },
            children: e,
          });
        }
        function s() {
      ...
      7674: (e, t, n) => {
        'use strict';
        n.d(t, { Lc: () => a, Nv: () => l, Sh: () => c, kx: () => u, sA: () => o, tF: () => s });
        let r = process.env.NEXT_PUBLIC_API_URL || 'http://localhost:3001/api';
        async function i() {
          return null;
        }
        async function l(e, t = {}) {
          let { method: n = 'GET', body: l, token: o } = t,
            a = o ?? (await i()),
            s = { 'Content-Type': 'application/json' };
          a && (s.Authorization = `Bearer ${a}`);
          let u = await fetch(`${r}${e}`, {
              method: n,
              headers: s,
              body: l ? JSON.stringify(l) : void 0,
            }),
            c = await u.json();
          if (!u.ok) throw Error(c.error?.message || 'Request failed');
          return c;
        }
        let o = {
            getDomains: () => l('/domains'),
            getDomain: e => l(`/domains/${e}`),
            getTasks: e => l(`/domains/${e}/tasks`),
            getStudyGuide: e => l(`/domains/tasks/${e}/study-guide`),
            markSectionComplete: e =>
              l(`/domains/progress/sections/${e}/complete`, { method: 'POST' }),
            getProgress: () => l('/domains/progress'),
          },
          a = {
            getFlashcards: e => {
            ...
            getDueForReview: e => l(`/flashcards/review${e ? `?limit=${e}` : ''}`),
            getStats: () => l('/flashcards/stats'),
            startSession: e => l('/flashcards/sessions', { method: 'POST', body: e }),
            recordResponse: (e, t, n, r) =>
              l(`/flashcards/sessions/${e}/responses/${t}`, {
                method: 'POST',
                body: { rating: n, timeSpentMs: r },
              }),
            completeSession: e => l(`/flashcards/sessions/${e}/complete`, { method: 'POST' }),
            createCustom: e => l('/flashcards/custom', { method: 'POST', body: e }),
          },
          s = {
            startSession: e => l('/practice/sessions', { method: 'POST', body: e }),
            submitAnswer: (e, t, n, r) =>
              l(`/practice/sessions/${e}/answers/${t}`, {
                method: 'POST',
                body: { selectedOptionId: n, timeSpentMs: r },
              }),
            completeSession: e => l(`/practice/sessions/${e}/complete`, { method: 'POST' }),
            startMockExam: () => l('/practice/mock-exams', { method: 'POST' }),
            getFlagged: () => l('/practice/flagged'),
            flagQuestion: e => l(`/practice/questions/${e}/flag`, { method: 'POST' }),
            unflagQuestion: e => l(`/practice/questions/${e}/flag`, { method: 'DELETE' }),
            getStats: () => l('/practice/stats'),
          },
          u = {
            getDashboard: () => l('/dashboard'),
            getStreak: () => l('/dashboard/streak'),
            getProgress: () => l('/dashboard/progress'),
            getActivity: e => l(`/dashboard/activity${e ? `?limit=${e}` : ''}`),
            getReviews: e => l(`/dashboard/reviews${e ? `?limit=${e}` : ''}`),
            getWeakAreas: () => l('/dashboard/weak-areas'),
            getReadiness: () => l('/dashboard/readiness'),
            getRecommendations: () => l('/dashboard/recommendations'),
          },
          c = {
            getFormulas: e => l(`/formulas${e ? `?category=${e}` : ''}`),
            getFormula: e => l(`/formulas/${e}`),
            calculate: (e, t) =>
              l(`/formulas/${e}/calculate`, { method: 'POST', body: { inputs: t } }),
            getVariables: () => l('/formulas/variables'),
          };
      },
      4773: (e, t, n) => {
        'use strict';
        (n.r(t), n.d(t, { default: () => s, metadata: () => a }));
        var r = n(9013),
          i = n(5900),
          l = n.n(i);
        n(5556);
        let o = (0, n(3189).createProxy)(
      ...
      7965: (e, t, n) => {
        ...
        let r = (0, n(3189).createProxy)(
          String.raw`/Users/dustinober/Projects/pmp_application/packages/web/src/app/study/[taskId]/page.tsx#default`
        );
      },
      5556: () => {},
    }));

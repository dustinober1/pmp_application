    ...
    (e.modules = {
      ...
      8804: (e, s, r) => {
        ...
        let l = [
              ...
              children: [
                'study',
                {
                  children: [
                    ...
                    {
                      page: [
                        () => Promise.resolve().then(r.bind(r, 2279)),
          ...
          c = ['/Users/dustinober/Projects/pmp_application/packages/web/src/app/study/page.tsx'],
          m = '/study/page',
      ...
      2315: (e, s, r) => {
        Promise.resolve().then(r.bind(r, 7005));
      },
      7005: (e, s, r) => {
        'use strict';
        ...
        function l() {
          (0, i.useRouter)();
          let { isAuthenticated: e, isLoading: s } = (0, d.a)(),
            [r, l] = (0, a.useState)([]),
            [c, m] = (0, a.useState)(!0),
              ...
              (0, t.jsxs)('main', {
                ...
                children: [
                  (0, t.jsxs)('div', {
                    className: 'mb-8',
                    children: [
                      t.jsx('h1', { className: 'text-2xl font-bold', children: 'Study Guide' }),
                      t.jsx('p', {
                  ...
                  t.jsx('div', {
                    ...
                    children: r.map(e =>
                      (0, t.jsxs)(
                        'div',
                        {
                          className: `card cursor-pointer transition-all hover:scale-[1.02] ${p === e.id ? 'ring-2 ring-[var(--primary)]' : ''}`,
                          onClick: () => u(p === e.id ? null : e.id),
                          children: [
                            t.jsx('div', {
                              className: `w-12 h-12 rounded-lg bg-gradient-to-br ${x[e.code] || 'from-gray-500 to-gray-600'} flex items-center justify-center mb-4`,
                              children: (0, t.jsxs)('span', {
                                className: 'text-white font-bold text-lg',
                                children: [e.weightPercentage, '%'],
                              }),
                            }),
                            t.jsx('h2', { className: 'text-lg font-semibold', children: e.name }),
                            (0, t.jsxs)('p', {
                              className: 'text-sm text-[var(--foreground-muted)] mt-2',
                              children: [e.description?.substring(0, 100), '...'],
                            }),
                            (0, t.jsxs)('div', {
                              className:
                              ...
                              children: [
                                (0, t.jsxs)('span', {
                                  ...
                                  children: [e.tasks?.length || 0, ' tasks'],
                                }),
                                t.jsx('span', {
                                  className: 'text-[var(--primary)] text-sm font-medium',
                                  children: p === e.id ? 'View Tasks ↓' : 'Expand →',
                                }),
                              ],
                            }),
                          ],
                    ...
                    (0, t.jsxs)('div', {
                      ...
                      children: [
                        (0, t.jsxs)('h2', {
                          ...
                          children: [r.find(e => e.id === p)?.name, ' - Tasks'],
                        }),
                        t.jsx('div', {
                                      ...
                                      children: [
                                        ...
                                        t.jsxs('div', {
                                          children: [
                                            ...
                                            t.jsxs('p', {
                                              className: 'text-sm text-[var(--foreground-muted)]',
                                              children: [e.description?.substring(0, 80), '...'],
                                            }),
                                          ],
                                        }),
                                      ],
      ...
      2279: (e, s, r) => {
        ...
        let t = (0, r(3189).createProxy)(
          String.raw`/Users/dustinober/Projects/pmp_application/packages/web/src/app/study/page.tsx#default`
        );
      },
    }));

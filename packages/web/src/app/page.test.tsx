...
describe('HomePage', () => {
  it('renders hero section with main heading', () => {
    ...
    expect(screen.getByRole('heading', { name: /pass the 2026 pmp exam/i })).toBeInTheDocument();
  ...
  it('renders features section with all features', () => {
    ...
    expect(screen.getByText('Spaced Repetition Flashcards')).toBeInTheDocument();
  ...
  it('renders feature descriptions', () => {
    ...
    expect(screen.getByText(/in-depth coverage of all pmp domains/i)).toBeInTheDocument();
    expect(
      screen.getByText(/realistic exam questions with detailed explanations/i)
    ).toBeInTheDocument();
    expect(screen.getByText(/optimize your memory with our sm-2 algorithm/i)).toBeInTheDocument();
  });
  ...
  it('renders CTA section', () => {
    ...
    expect(
      screen.getByText(/join thousands of successful pmp-certified professionals/i)
    ).toBeInTheDocument();
  });

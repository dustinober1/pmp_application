...
export default function FlaggedQuestionsPage() {
  ...
  const handleUnflag = async (questionId: string, e: React.MouseEvent) => {
    ...
    try {
      await apiRequest(`/practice/questions/${questionId}/flag`, {
        method: "DELETE",
      });
        ...
        {questions.length === 0 ? (
          <div className="card text-center py-12">
            ...
            <p className="text-[var(--foreground-muted)] mb-6">
              Flags are a great way to mark questions you want to review later.
              Flag questions during any practice session or mock exam.
            </p>

    ...
    return (
      <div className="min-h-screen flex items-center justify-center px-4 py-12 relative overflow-hidden">
        ...
        <div className="card w-full max-w-md animate-slideUp relative z-10 bg-md-surface-container text-center">
          ...
          <h2 className="text-3xl font-extrabold text-md-on-surface">
            Check your email
          </h2>
          <p className="mt-2 text-sm text-md-on-surface-variant">
            We have sent a password reset link to{" "}
            <span className="font-medium text-md-primary">{email}</span>. Please
          ...
          <div className="mt-6 space-y-3">
            ...
            <p className="text-sm text-md-on-surface-variant">
              ...
              <span className="font-mono font-bold text-md-primary">
                {countdown}
              </span>

...
export const metadata: Metadata = {
  ...
  description:
    "Terms of Service and User Agreement for PMP Study Pro platform.",
};
        ...
        <div className="prose prose-lg dark:prose-invert max-w-none">
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-600 dark:text-gray-300">
              By accessing or using PMP Study Pro (&quot;the Service&quot;), you
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 text-gray-600 dark:text-gray-300 space-y-2">
              ...
              <li>
                We reserve the right to modify subscription fees with 30 days
                notice
              </li>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-600 dark:text-gray-300 mb-4">
              ...
              by PMP Study Pro and are protected by international copyright,
              trademark, and other intellectual property laws.
            </p>
            <ul className="list-disc pl-6 text-gray-600 dark:text-gray-300 space-y-2">
              <li>
                You retain ownership of content you create (flashcards, notes)
              </li>
              <li>
                You grant us a license to use your content for service provision
              </li>
              <li>
                Our study materials are for your personal, non-commercial use
              </li>
              <li>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-600 dark:text-gray-300">
              IN NO EVENT SHALL PMP STUDY PRO BE LIABLE FOR ANY INDIRECT,
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-600 dark:text-gray-300">
              ...
              terms taking effect. Your continued use of the Service after such

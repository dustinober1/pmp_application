...
function TestConsumer() {
  ...
  return (
    <div>
      ...
      <button
        onClick={() => auth.register("test@example.com", "password", "Test")}
      >
        Register
      </button>
  ...
  it("login updates auth state", async () => {
    mockedApiRequest
      ...
      .mockResolvedValueOnce({
        success: true,
        data: {
          user: { id: "1", name: "Logged In User", email: "test@example.com" },
        },
      }); // login
  ...
  it("register updates auth state", async () => {
    mockedApiRequest
      ...
      .mockResolvedValueOnce({
        success: true,
        data: {
          user: { id: "1", name: "New User", email: "test@example.com" },
        },
      }); // register
  ...
  it("refreshToken re-hydrates on success", async () => {
    mockedApiRequest
      ...
      .mockResolvedValueOnce({
        success: true,
        data: {
          user: { id: "1", name: "Refreshed User", email: "test@example.com" },
        },
  ...
  it("refreshUser re-fetches user data", async () => {
    mockedApiRequest
      .mockResolvedValueOnce({
        success: true,
        data: {
          user: { id: "1", name: "Original", email: "test@example.com" },
        },
      }) // initial hydrate
      .mockResolvedValueOnce({
        success: true,

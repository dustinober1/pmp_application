...
test.describe("Practice Exam Flows", () => {
  test.describe("Auth Redirect - Practice Page", () => {
    test("should redirect to login when accessing practice page without auth", async ({
      page,
    }) => {
  ...
  test.describe("Auth Redirect - Session Pages", () => {
    test("should redirect to login when accessing session without auth", async ({
      page,
    }) => {
    ...
    test("should redirect to login when accessing mock session without auth", async ({
      page,
    }) => {

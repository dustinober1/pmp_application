...
test.describe("Checkout Flow", () => {
  test.describe("Pricing Page", () => {
    ...
    test("should display correct pricing for monthly billing", async ({
      page,
    }) => {
      await page.goto("/pricing");
    ...
    test("should toggle to annual billing and update prices", async ({
      page,
    }) => {
      await page.goto("/pricing");
    ...
    test("should switch between monthly and annual billing", async ({
      page,
    }) => {
      await page.goto("/pricing");

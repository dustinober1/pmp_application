...
| ---------------------- | --------------------------------- | -------------------------------- |
| **Planned Value (PV)** | Budgeted cost of work _scheduled_ | What should we have done by now? |
| **Earned Value (EV)**  | Budgeted cost of work _performed_ | What did we actually accomplish? |
...
| ----------- | ---------------------------------- | --------------------------------------------------------------- | ---------------------------- |
| **Lagging** | Measures outcomes _after_ the fact | Final cost, items delivered, defects in production              | Learn for next time          |

...
- **Brainstorming**: Facilitated sessions with the team to list all potential stakeholders. Use prompts like "Who pays?", "Who uses?", "Who approves?", "Who blocks?".
- **Expert Judgment**: Consult SMEs, past project managers, and organizational veterans who understand the political landscape.
- **Stakeholder Templates**: Use organizational checklists (standard roles like Legal, Compliance, HR, Procurement) to ensure coverage.
- **Org Chart Analysis**: Walk through the formal organization chart, but remember: influence doesn't always follow the lines.
...
- **4.1a Mapping**: Using the Power/Interest Grid and Salience Model to prioritize engagement.
- **4.1b Classification**: Maintaining the Stakeholder Register and analyzing direction of influence.
...
The most dangerous stakeholder is the one you didn't find. Always ask your known stakeholders: _"Who else should I be talking to about this?"_
:::

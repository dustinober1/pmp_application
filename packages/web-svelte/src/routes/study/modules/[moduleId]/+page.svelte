...
<div class="min-h-screen bg-gray-50 dark:bg-gray-900 py-8">
	<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
		<nav class="mb-8 flex items-center gap-4 text-sm">
			<a href="{base}/study" class="text-indigo-600 dark:text-indigo-400 hover:underline">
				← Back to Study Hub
			</a>
			<span class="text-gray-400">/</span>
			<span class="text-gray-600 dark:text-gray-300 font-medium">{data.module.title}</span>
		</nav>

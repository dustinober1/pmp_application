...
describe("ConsentService", () => {
  ...
  describe("getUserConsent", () => {
    it("should return user consent when it exists", async () => {
      vi.mocked(prisma.privacyConsent.findUnique).mockResolvedValue(
        mockConsent,
      );
  ...
  describe("hasConsent", () => {
    ...
    it("should check specific consent types", async () => {
      ...
      const cookieConsent = await consentService.hasConsent(
        mockUserId,
        "cookies",
      );
      const privacyConsent = await consentService.hasConsent(
        mockUserId,
        "privacy",
      );

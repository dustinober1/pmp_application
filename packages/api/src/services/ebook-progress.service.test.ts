...
describe("EbookProgressService", () => {
  ...
  describe("updateProgress", () => {
    it("should create new progress record when none exists", async () => {
      ...
      const result = await ebookProgressService.updateProgress(
        userId,
        chapterSlug,
        sectionSlug,
      );
  ...
  describe("getChapterProgress", () => {
    ...
    it("should return chapter progress with completed sections", async () => {
      ...
      const result = await ebookProgressService.getChapterProgress(
        userId,
        chapterSlug,
      );
    ...
    it("should throw error when chapter not found", async () => {
      ...
      await expect(
        ebookProgressService.getChapterProgress(userId, chapterSlug),
      ).rejects.toThrow(`Chapter not found: ${chapterSlug}`);
    });
  });
  ...
  describe("markSectionComplete", () => {
    ...
    it("should throw error when chapter not found", async () => {
      ...
      await expect(
        ebookProgressService.markSectionComplete(
          userId,
          chapterSlug,
          sectionSlug,
        ),

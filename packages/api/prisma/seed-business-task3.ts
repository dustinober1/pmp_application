...
const flashcards = [
  ...
  {
    front: 'What is the primary purpose of **Perform Integrated Change Control**?',
  ...
  {
    front: 'Who typically approves a Change Request (CR) that impacts the baselines?',
  ...
  {
    front: '**Scenario**: A stakeholder requests a "small" change. What is the **First Step**?',
  ...
  {
    front: '**Scenario**: The CCB rejects a key change request. What do you do?',
  ...
  {
    front: '**Scenario**: A Change Request is approved. What is the **Immediate Next Step**?',
    back: '**Update the Baselines** (Plan) and then **Implement** the change.',
  },
  {
    front: '**Scenario**: A Change Request is approved. What happens to the **Change Log**?',
  ...
  {
    front: '**Scenario**: The project is over budget. You want to cut scope to save money.',
    back: 'Submit a **Change Request** to reduce the Scope Baseline. You cannot just delete scope without approval.',
  },
  {
    front: '**Scenario**: A stakeholder sends you an email asking for a change.',
  ...
  {
    front: '**Scenario**: A change is approved, but the team is resistant to doing it.',
  ...
  {
    front: '**True or False**: "Just Do It" is a valid Change Management strategy.',
  ...
  {
    front: '**Scenario**: The customer cancels the project via a "Major Change."',
...
async function main() {
  console.log('🌱 Seeding flashcards for Business Task 3: Manage and Control Changes...');

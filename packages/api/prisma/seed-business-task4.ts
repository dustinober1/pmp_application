...
const flashcards = [
  ...
  {
    front:
      "**Scenario**: A team member mentions a blocker in the daily stand-up.",
  ...
  {
    front:
      "**Scenario**: A minor documentation error is found 3 months before launch.",
  ...
  {
    front:
      "**Scenario**: You assign an issue to a team member. They push back.",
  ...
  {
    front:
      "What are the **4 Resolution Strategies** (imilar to Risk Responses)?",
  ...
  {
    front:
      "**Scenario**: You need a specialist but they are assigned to another project.",
  ...
  {
    front:
      "**True or False**: You should hide issues from stakeholders to avoid panic.",
  ...
  {
    front:
      "**Scenario**: The project is complete. What happens to open issues?",
  ...
  {
    front:
      "**True or False**: You should wait to log an issue until you understand it fully.",
  ...
  {
    front:
      "**True or False**: You can close an issue without verifying the fix.",
...
async function main() {
  console.log(
    "🌱 Seeding flashcards for Business Task 4: Remove Impediments and Manage Issues...",
  );
